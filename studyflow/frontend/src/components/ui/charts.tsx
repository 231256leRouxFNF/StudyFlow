...
function ChartTooltipContent({
  ...
  nameKey,
  labelKey,
}: // Recharts tooltip props are complex / generic; use any to avoid type discrepancies
  any &
  React.ComponentProps<"div"> & {
    hideLabel?: boolean;
...
function ChartLegendContent({
  ...
  nameKey,
    ...
    // accept legend payload and verticalAlign with loose typing to avoid
    // incompatibilities with upstream Recharts types
    payload?: any[];
